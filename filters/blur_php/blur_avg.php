<?php
	shell_exec('python ../blur_py/blur_avg.py');
?>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-5 img-box">
				<h3 class="text-center" style='font-family:Tw cen mt'>After Averaging</h3>
				<?php echo '<img src=\'../../images/abc_blur_avg.jpg\' class=\'rounded img-fluid\'>'; ?>
			</div>
